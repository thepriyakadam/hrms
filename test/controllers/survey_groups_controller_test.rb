...
class SurveyGroupsControllerTest < ActionController::TestCase
  ...
  test "should create survey_group" do
    assert_difference('SurveyGroup.count') do
      post :create, survey_group: { contact: @survey_group.contact, employee_id: @survey_group.employee_id, name: @survey_group.name, role: @survey_group.role, status: @survey_group.status }
    end
  ...
  test "should update survey_group" do
    patch :update, id: @survey_group, survey_group: { contact: @survey_group.contact, employee_id: @survey_group.employee_id, name: @survey_group.name, role: @survey_group.role, status: @survey_group.status }
    assert_redirected_to survey_group_path(assigns(:survey_group))
  end
