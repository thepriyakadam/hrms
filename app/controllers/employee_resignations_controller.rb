class EmployeeResignationsController < ApplicationController
  ...
  #   # byebug
  #   @employee_resignation = EmployeeResignation.find(params[:resignation_id])
  #   @employee_resignation.update(resign_status: "Edit & Approved",employee_id: params[:employee_resignation][:employee_id],resign_status: params[:employee_resignation][:resign_status],reporting_master_id: params[:employee_resignation][:reporting_master_id],resignation_date: params[:employee_resignation][:resignation_date],reason: params[:employee_resignation][:reason],is_notice_period: params[:employee_resignation][:is_notice_period],notice_period: params[:employee_resignation][:notice_period],short_notice_period: params[:employee_resignation][:short_notice_period],tentative_leaving_date: params[:employee_resignation][:tentative_leaving_date],remark: params[:employee_resignation][:remark],exit_interview_date: params[:employee_resignation][:exit_interview_date],note: params[:employee_resignation][:note],leaving_date: params[:employee_resignation][:leaving_date],settled_on: params[:employee_resignation][:settled_on],has_left: params[:employee_resignation][:has_left],notice_served: params[:employee_resignation][:notice_served],rehired: params[:employee_resignation][:rehired],leaving_reason_id: params[:employee_resignation][:leaving_reason_id],is_stop_pay_request: params[:employee_resignation][:is_stop_pay_request])
  ...
  #   ReportingEmployeeResignation.create(reporting_master_id: @employee_resignation.reporting_master_id, employee_resignation_id: @employee_resignation.id, status: @employee_resignation.resign_status)
  #   EmployeeResignationMailer.edit_and_approve(@employee_resignation).deliver_now
 
  #   flash[:notice] = "Resignation Details Updated & Approved Successfully"
  #   redirect_to resignation_history_employee_resignations_path
  # end
    ...
    redirect_to resignation_history_employee_resignations_path
    flash[:notice] = ' Resignation Edited And Approved Successfully.'   
