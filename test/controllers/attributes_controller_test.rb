...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { code: @attribute.code, definition: @attribute.definition, name: @attribute.name, status: @attribute.status }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { code: @attribute.code, definition: @attribute.definition, name: @attribute.name, status: @attribute.status }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
