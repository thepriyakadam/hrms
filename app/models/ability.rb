  ...
  def initialize(user)
    if user.class == Group
      ...
      if user.role.name == 'Company'
        ...
        can [:read, :create, :update, :destroy], [EmployeeLeavRequest,CompanyLeav,Award,Family,Qualification,Skillset,Experince,Certification,EmplyeePhysical,LeavCancelled]
      end
    end 
