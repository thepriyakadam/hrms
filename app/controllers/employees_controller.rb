class EmployeesController < ApplicationController
  ...
  private
    ...
    def employee_params
      ...
      params.require(:employee).permit(:department_id, :first_name, :middle_name, :last_name, :date_of_birth, :contact_no, :email, :permanent_address, :city, :district, :state, :pin_code, :current_address, :adhar_no, :pan_no, :licence_no, :passport_no, :marital_status, :nationality_id, :blood_group_id, :handicap, :status, :employee_type_id, :gender, joining_detail_attributes: [:joining_date, :reffernce_from, :admin_hr, :tech_hr, :designation, :ctc, :account, :employee_grade, :confirmation_date, :status, :probation_period, :notice_period, :medical_schem])
    end
end
