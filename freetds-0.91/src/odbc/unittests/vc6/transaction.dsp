# Microsoft Developer Studio Project File - Name="transaction" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=transaction - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "transaction.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "transaction.mak" CFG="transaction - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "transaction - Win32 Release" (based on "Win32 (x86) Console Application")
...
!IF  "$(CFG)" == "transaction - Win32 Release"
...
!ELSEIF  "$(CFG)" == "transaction - Win32 Debug"
...
# Name "transaction - Win32 Release"
# Name "transaction - Win32 Debug"
