...
class LeaveCOffsController < ApplicationController
  ...
  def update
    ...
    if joining_detail.c_off_expire == true
      c_off_expire_day = joining_detail.c_off_applicable_day.to_f
      @expiry_date = params_c_off_date + c_off_expire_day.to_f
      @expiry_status = true
    else
      c_off_expire_day = nil
      @expiry_date = nil
    ...
    if @leave_c_off.c_off_type == params_c_off_type
      @leave_c_off.update(employee_id: params_employee_id,c_off_date: params_c_off_date,c_off_type: params_c_off_type,c_off_expire_day: c_off_expire_day,expiry_status: @expiry_status,is_taken: false,expiry_date: @expiry_date,leave_count: @leave_c_off.leave_count,is_expire: nil)
    else
      if params_c_off_type == "Full Day"
        @leave_c_off.update(employee_id: params_employee_id,c_off_date: params_c_off_date,c_off_type: params_c_off_type,c_off_expire_day: c_off_expire_day,expiry_status: @expiry_status,is_taken: false,expiry_date: @expiry_date,leave_count: 1,is_expire: nil) 
        ...
        @leave_c_off.update(employee_id: params_employee_id,c_off_date: params_c_off_date,c_off_type: params_c_off_type,c_off_expire_day: c_off_expire_day,expiry_status: @expiry_status,is_taken: false,expiry_date: @expiry_date,leave_count: 0.5,is_expire: nil)
        @employee_leave_balance.update(total_leave: @employee_leave_balance.total_leave.to_f - 0.5)
        @employee_leave_balance.update(no_of_leave: @employee_leave_balance.no_of_leave.to_f - 0.5)
      end
    end
