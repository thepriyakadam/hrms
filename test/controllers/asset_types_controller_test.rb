...
class AssetTypesControllerTest < ActionController::TestCase
  ...
  test "should create asset_type" do
    assert_difference('AssetType.count') do
      post :create, asset_type: { code: @asset_type.code, description: @asset_type.description, name: @asset_type.name }
    end
  ...
  test "should update asset_type" do
    patch :update, id: @asset_type, asset_type: { code: @asset_type.code, description: @asset_type.description, name: @asset_type.name }
    assert_redirected_to asset_type_path(assigns(:asset_type))
  end
