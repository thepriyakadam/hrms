...
class RewardTypesControllerTest < ActionController::TestCase
  ...
  test "should create reward_type" do
    assert_difference('RewardType.count') do
      post :create, reward_type: { code: @reward_type.code, description: @reward_type.description, name: @reward_type.name, status: @reward_type.status }
    end
  ...
  test "should update reward_type" do
    patch :update, id: @reward_type, reward_type: { code: @reward_type.code, description: @reward_type.description, name: @reward_type.name, status: @reward_type.status }
    assert_redirected_to reward_type_path(assigns(:reward_type))
  end
