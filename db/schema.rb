...
ActiveRecord::Schema.define(version: 20171117113251) do
  ...
  create_table "employee_plans", force: :cascade do |t|
    ...
    t.float    "latitude",                 limit: 24
    t.float    "longitude",                limit: 24
    t.integer  "plan_reason_master_id_id", limit: 4
  ...
  add_index "employee_plans", ["plan_reason_master_id_id"], name: "index_employee_plans_on_plan_reason_master_id_id", using: :btree
