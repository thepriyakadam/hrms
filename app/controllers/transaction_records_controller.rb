class TransactionRecordsController < ApplicationController
  ...
  private
    ...
    def transaction_record_params
      params.require(:transaction_record).permit(:email_msg,:reminder_to,:compliance_type_id, :transaction_type, :submission_date, :reminder_Date, :previous_days, :after_days, :email_1, :email_2, :email_3, :status, :is_confirm)
    end
end
