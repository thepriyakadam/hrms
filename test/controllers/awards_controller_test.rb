...
class AwardsControllerTest < ActionController::TestCase
  ...
  test 'should create award' do
    assert_difference('Award.count') do
      post :create, award: { award_from: @award.award_from, award_name: @award.award_name, employee_id: @award.employee_id, year: @award.year }
    end
  ...
  test 'should update award' do
    patch :update, id: @award, award: { award_from: @award.award_from, award_name: @award.award_name, employee_id: @award.employee_id, year: @award.year }
    assert_redirected_to award_path(assigns(:award))
  end
