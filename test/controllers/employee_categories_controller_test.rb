...
class EmployeeCategoriesControllerTest < ActionController::TestCase
  ...
  test 'should create employee_category' do
    assert_difference('EmployeeCategory.count') do
      post :create, employee_category: { code: @employee_category.code, description: @employee_category.description, name: @employee_category.name }
    end
  ...
  test 'should update employee_category' do
    patch :update, id: @employee_category, employee_category: { code: @employee_category.code, description: @employee_category.description, name: @employee_category.name }
    assert_redirected_to employee_category_path(assigns(:employee_category))
  end
