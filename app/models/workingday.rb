    ...
    (2..spreadsheet.last_row).each do |i|
      ...
      @workingday_data = Workingday.where(employee_id: employee_id,month_name: month_name,year: year).take 
        ...
        if @workingday_data == nil
          @workingday = Workingday.create(employee_id: employee_id,ot_hours: ot_hours, month_name: month_name,year: year,payable_day: payable_day,date: date.to_date)
        else
          if @workingday_data.paid == nil
            @workingday_data.update(employee_id: employee_id,ot_hours: ot_hours,month_name: month_name,year: year,payable_day: payable_day,date: date.to_date)
          else
