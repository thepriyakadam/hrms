...
class InterviewTypesControllerTest < ActionController::TestCase
  ...
  test "should create interview_type" do
    assert_difference('InterviewType.count') do
      post :create, interview_type: { code: @interview_type.code, description: @interview_type.description, name: @interview_type.name }
    end
  ...
  test "should update interview_type" do
    patch :update, id: @interview_type, interview_type: { code: @interview_type.code, description: @interview_type.description, name: @interview_type.name }
    assert_redirected_to interview_type_path(assigns(:interview_type))
  end
