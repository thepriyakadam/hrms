...
ActiveRecord::Schema.define(version: 20170511092455) do
  ...
  add_index "access_issue_requests", ["issue_tracker_member_id"], name: "index_access_issue_requests_on_issue_tracker_member_id"
  ...
  create_table "employee_jc_lists", force: :cascade do |t|
    t.integer  "joining_checklist_master_id"
    t.integer  "employee_id"
    t.integer  "admin_id"
    t.boolean  "status",                      default: false
    t.datetime "created_at",                                  null: false
  ...
  add_index "employee_jc_lists", ["employee_id"], name: "index_employee_jc_lists_on_employee_id"
  add_index "employee_jc_lists", ["joining_checklist_master_id"], name: "index_employee_jc_lists_on_joining_checklist_master_id"
  ...
  add_index "employees", ["punch_card_id"], name: "index_employees_on_punch_card_id"
  ...
  add_index "texable_monthly_deductions", ["salaryslip_id"], name: "index_texable_monthly_deductions_on_salaryslip_id"
  ...
  add_index "visitor_details", ["employee_id"], name: "index_visitor_details_on_employee_id"
