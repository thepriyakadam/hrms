...
class MembershipTypesControllerTest < ActionController::TestCase
  ...
  test "should create membership_type" do
    assert_difference('MembershipType.count') do
      post :create, membership_type: { code: @membership_type.code, name: @membership_type.name, status: @membership_type.status }
    end
  ...
  test "should update membership_type" do
    patch :update, id: @membership_type, membership_type: { code: @membership_type.code, name: @membership_type.name, status: @membership_type.status }
    assert_redirected_to membership_type_path(assigns(:membership_type))
  end
