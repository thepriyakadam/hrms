...
class IssueTypesControllerTest < ActionController::TestCase
  ...
  test "should create issue_type" do
    assert_difference('IssueType.count') do
      post :create, issue_type: { is_confirm: @issue_type.is_confirm, name: @issue_type.name, status: @issue_type.status }
    end
  ...
  test "should update issue_type" do
    patch :update, id: @issue_type, issue_type: { is_confirm: @issue_type.is_confirm, name: @issue_type.name, status: @issue_type.status }
    assert_redirected_to issue_type_path(assigns(:issue_type))
  end
