...
1.upto(4) do |line| # dewas jan 2016
  ...
  unless @employee.nil?
    ...
    Workingday.new do |w|
      ...
      w.week_off_day = ex.cell(line, 'G')

     
      w.cl_leave = ex.cell(line, 'H').to_i
      w.el_leave = ex.cell(line, 'I').to_i
      w.esic_leave = ex.cell(line, 'J').to_i

      
      w.holiday_in_month = ex.cell(line, 'K')
