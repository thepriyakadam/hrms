...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { code: @agency.code, description: @agency.description, is_active: @agency.is_active, name: @agency.name }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { code: @agency.code, description: @agency.description, is_active: @agency.is_active, name: @agency.name }
    assert_redirected_to agency_path(assigns(:agency))
  end
