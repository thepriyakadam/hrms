...
ActiveRecord::Schema.define(version: 20180131125432) do
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.string   "employee_option",                 limit: 255
  end
  ...
  create_table "latemark_deductions", force: :cascade do |t|
    t.integer  "employee_id",     limit: 4
    t.date     "latemark_day"
    t.string   "latemark_count",  limit: 255
    t.decimal  "latemark_amount",             precision: 10
    t.datetime "created_at",                                 null: false
    t.datetime "updated_at",                                 null: false
  end

  add_index "latemark_deductions", ["employee_id"], name: "index_latemark_deductions_on_employee_id", using: :btree
  ...
  add_index "latemark_totals", ["employee_id"], name: "index_latemark_totals_on_employee_id", using: :btree
  ...
  create_table "leave_travel_assistances", force: :cascade do |t|
    t.integer  "investment_declaration_id", limit: 4
    t.date     "journey_date_from"
    t.date     "journey_date_to"
    t.string   "location_from",             limit: 255
    t.string   "location_to",               limit: 255
    t.string   "traveller_name",            limit: 255
    t.string   "relation_with_emp",         limit: 255
    t.string   "travel_mode",               limit: 255
    t.decimal  "estimated_travel_amt",                  precision: 10
    t.decimal  "actual_travel_amt",                     precision: 10
    t.decimal  "total",                                 precision: 10
    t.datetime "created_at",                                           null: false
    t.datetime "updated_at",                                           null: false
  end
  ...
  add_foreign_key "latemark_deductions", "employees"
  add_foreign_key "latemark_totals", "employees"
