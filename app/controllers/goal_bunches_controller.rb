class GoalBunchesController < ApplicationController
  ...
  def appraiser_comment
    ...
    @goal_bunch = GoalBunch.where(employee_id: @employee.id, appraisee_confirm: true).take
    if @goal_bunch.nil?
      @goal_ratings = []
  ...
  def final_create
    ...
    redirect_to final_comment_goal_bunches_path(id: @employee.id)
  ...
  def update_final_modal
    ...
    redirect_to final_comment_goal_bunches_path(id: @goal_bunch.employee_id)
  end
  ...
  def appraiser_overall_comment_create
    ...
    flash[:notice] = "Overall Comment Created Successfully"
    redirect_to appraiser_comment_goal_bunches_path(id: @goal_bunch.employee_id)
  end
  ...
  def reviewer_overall_comment_create
    ...
    redirect_to reviewer_comment_goal_bunches_path(id: @goal_bunch.employee_id)
  end
