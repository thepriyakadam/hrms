class InterviewAnalysesController < ApplicationController
  ...
  def create
    ...
    @interview_round = InterviewRound.find(params[:interview_round_id])
      ...
      @interview_analyses = InterviewAnalysis.where(id: @interview_analysis.id,interview_round_id: @interview_round.id).update_all(interview_schedule_id: @interview_round.interview_schedule_id)  
        @interview_analysis = InterviewAnalysis.new
